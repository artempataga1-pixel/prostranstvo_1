...
const steps = [
  "Провели аудит текущих бизнес-процессов: как ведётся работа с клиентами, какие задачи падают, где теряются сделки",
  "Сформировали требования к CRM: функциональность, интеграции (телефония, почта, мессенджеры), права доступа",
  "Подобрали оптимальную CRM-систему из 5 вариантов на основе требований, бюджета и масштаба бизнеса",
  "Настроили воронки продаж, автоматические задачи, шаблоны сообщений и правила распределения лидов",
  "Провели миграцию данных из Excel и старых систем: очистка, дедупликация, структурирование базы контактов",
  "Обучили команду: менеджеры, руководители отдела продаж — 2-дневный тренинг с практическими кейсами",
];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span style={{ color: "rgba(255,255,255,0.2)", fontSize: 14 }}>/</span>
        <span style={{ color: "rgba(255,255,255,0.7)", fontSize: 14 }}>CRM Система</span>
      </header>
