...
const steps = [
  "Провели аудит бизнес-процессов клиента: выявили рутинные задачи, занимающие 60%+ рабочего времени команды",
  "Определили приоритетные процессы для автоматизации: обработка заявок, формирование отчётов, коммуникация с клиентами",
  "Разработали архитектуру ИИ-агентов на базе современных LLM с интеграцией в существующие системы клиента",
  "Настроили агентов для обработки входящих запросов: автоответы, классификация, маршрутизация по отделам",
  "Внедрили ИИ-агента для генерации аналитических отчётов: данные из CRM и маркетплейсов обрабатываются автоматически",
  "Провели обучение команды: как контролировать агентов, настраивать промпты и расширять их возможности",
];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span style={{ color: "rgba(255,255,255,0.2)", fontSize: 14 }}>/</span>
        <span style={{ color: "rgba(255,255,255,0.7)", fontSize: 14 }}>ИИ Агенты</span>
      </header>
